...
from YUKIIMUSIC.misc import _boot_
from YUKIIMUSIC.plugins.sudo.sudoers import sudoers_list
from YUKIIMUSIC.utils.database import get_served_chats, get_served_users, get_sudoers
from YUKIIMUSIC.utils import bot_sys_stats
...
from YUKIIMUSIC.utils.decorators.language import LanguageStart
from YUKIIMUSIC.utils.formatters import get_readable_time
...
async def start_pm(client, message: Message, _):
    ...
    await asyncio.sleep(0.4)
    await loading_1.edit_text("<emoji id='5413840936994097463'>🌺</emoji> <b>ϻᴜsɪᴄ ꭙ ϻᴜsɪᴄ ♪\nsᴛᴧʀᴛed!</b>")
